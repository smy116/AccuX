...
namespace AccuX.Host
{
    public sealed partial class ExcelRangeOperationHost
    {
        ...
        /// </summary>
        private static bool[] ReadHiddenRows(Excel.Worksheet worksheet, Excel.Range range, int rowCount)
        {
        ...
        /// 以避免兼容宿主把混合状态误报为“全部可见”。
        /// </summary>
        private static bool[] ReadHiddenColumns(Excel.Worksheet worksheet, Excel.Range range, int columnCount)
        {
        ...
        private static bool TryConvertBooleanValue(object raw, out bool hidden)
        {
